  ...
  return (
    <footer className="bg-[#1D2B49] text-white/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            <a href="#" className="flex items-center gap-2 mb-4">
              <img src={logo} alt="Fera Digital Solutions" className="h-10 w-auto brightness-0 invert" />
            </a>
            ...
            <div className="flex items-center gap-4 mt-6">
              <a 
                href="https://www.instagram.com/femodera" 
                target="_blank" 
              ...
              <a 
                href="https://facebook.com/hare/17pEbfty6H/?mibextid=wwXifr" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors"
                aria-label="Facebook"
              ...
              <a 
                href="mailto:femoderalab@gmail.com" 
                className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors"
                aria-label="Email"
              >
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-3 text-white/60">
                ...
                <span>femoderalab@gmail.com</span>
              </li>
              <li className="flex items-center gap-3 text-white/60">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>+234 810 610 8753</span>
              </li>
              <li className="flex items-center gap-3 text-white/60">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Bottom Bar with Privacy and Terms - Using proper links */}
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm">
          <p className="text-white/40">© {new Date().getFullYear()} Fera Digital Solutions</p>
